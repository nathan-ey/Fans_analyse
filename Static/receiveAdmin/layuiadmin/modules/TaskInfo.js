...
layui.define(['table', 'form'], function(exports){
    ...
    var tableIns = table.render({
        elem: '#LAY-fs-manage',
        url: "http://8.134.62.33/realizationAdmin/get_task?token="+mybck+"&status=1",
        cellMinWidth : 95,
        ...
        cols : [[
            ...
            {field: 'doing_nums', title: '任务数', width:180, align:'center'},
    ...
    var active = {
        reload:function(){
            ...
            //     }
            //     ,where: {
            //         user_id: $("#memberUser option:selected").val(),
            //     }
            // });
            ...
            if($("#memberUser option:selected").val() == 777){
                ...
                //执行重载
                table.reload('systemLog', {
                    url: "http://8.134.62.33/realizationAdmin/get_task?token="+mybck+"&status=1&user_id="+$("#memberUser option:selected").val(),
                    page: {
                        curr: 1 //重新从第 1 页开始
                    }
                    // ,where: {
