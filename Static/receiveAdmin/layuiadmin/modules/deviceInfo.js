...
layui.define(['table', 'form'], function(exports){
    ...
    var tableIns = table.render({
        elem: '#LAY-fs-manage',
        url: "http://8.134.62.33/realizationAdmin/get_devices_detail?token="+mybck+"&type=1&status=1&action=all",
        cellMinWidth : 95,
        ...
        cols : [[
            ...
            {field: 'remark', title: '设备内容', width:180, align:'center'},
            ...
            // {field: 'money', title: '购买金额', width:180, align:'center'},
            // {field: 'num', title: '购买个数', width:180, align:'center'},
            // {field: 'type', title: '设备类型', width:180, align:'center'},
    ...
    var active = {
        reload:function(){
            ...
            if($("#deviceType option:selected").val() == 777){
                ...
                table.reload('systemLog', {
                    ...
                    // ,where: {
                    //     type: $("#deviceType option:selected").val(),
                    // }
                });
                ...
                //执行重载
                table.reload('systemLog', {
                    url: "http://8.134.62.33/realizationAdmin/get_devices_detail?token="+mybck+"&type="+$("#deviceType option:selected").val()+"&status=1",
                    page: {
                        curr: 1 //重新从第 1 页开始
                    }
                    // ,where: {
