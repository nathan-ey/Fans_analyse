...
layui.define(['table', 'form'], function(exports){
    ...
    table.render({
        elem: '#LAY-fs-manage',
        // url: "http://8.134.62.33/receptionAdmin/get_task?token="+mybck+"&status=1&user_id="+UserIDStr,
        url: "http://8.134.62.33/receptionAdmin/get_task_orders?token="+mybck+"&action=realizationAdmin&realization_status=2",
        cellMinWidth : 95,
        ...
        cols : [[
            ...
            {field: 'date', title: '任务日期', width:120, align:'center'},
            {field: 'project_id', title: '项目类型', width:180, align:'center'},
            {field: 'realization_nums', title: '任务数', width:180, align:'center'},
            {field: 'realization_status', title: '购粉状态',sort: true,width:150, align:'center',templet:function(d){
                    if(d.realization_status === 1){//未接任务
                        return '<button class="layui-btn layui-bg-red layui-btn-xs">'+'未提交'+'</button>'
                    }else if(d.realization_status === 2){//已接任务
            ...
            // {field: 'reception_list_id', title: '状态', width:180,align:'center',templet:function(d){
            //         if(d.reception_list_id == 0){
            //             // return '<span style="color: red">'+"异常"+'</span>'
            //             return '<button class="layui-btn layui-bg-red  layui-btn-xs">'+'管理员未审核提交'+'</button>'
            //         }else{
            //             // return '<span style="color: cornflowerblue">'+"正常"+'</span>'
            //             return '<button class="layui-btn layui-bg-green  layui-btn-xs">'+'管理员已提交'+'</button>'
            //         }
            // }},
            ...
            var index = layui.layer.open({
                ...
                success : function(layero, index){
                    ...
                    if(newdata) {
                        ...
                        body.find("#nums").val(newdata.realization_nums);
                        body.find("#realizationstatus").attr("value", newdata.status);
