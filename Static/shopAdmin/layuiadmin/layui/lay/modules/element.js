                ...
                clickThis: function() {
                    ...
                    if (i.hasClass(u)) {
                        ...
                        if(c[0]) {
                            ...
                            //判断是否存在layadmin-side-shrink
                            if (!layui.jquery('#'+layui.setter.container).hasClass('layadmin-side-shrink')){
                                //判断是否存在layui-nav-itemed
                                !c.parent().hasClass(r + "ed")&& (cs1="addClass",cs2="slideDown",cs3="show");

                                //展开收缩动画，添加删除layui-nav-itemed，隐藏显示下级小三角,（收缩动画&&删除下级layui-nav-itemed，收缩下级）
