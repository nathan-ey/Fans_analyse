...
layui.define(['table', 'form'], function(exports){
    ...
    table.render({
        elem: '#LAY-fs-manage',
        url: "http://8.134.62.33/shopAdmin/get_channel?token="+mybck+"&status=1", //模拟接口
        cellMinWidth : 95,
        ...
        cols : [[
            ...
            //         // return '<span style="color: cornflowerblue">'+"正常"+'</span>'
            //         return '<button class="layui-btn layui-bg-gray  layui-btn-xs">'+'接待管理员'+'</button>'
    ...
    table.on('tool(LAY-fs-manage)', function(obj){
        ...
        if(layEvent === 'look'){
            ...
            var index = layui.layer.open({
                ...
                success : function(layero, index){
                    ...
                    if(newdata) {
                        ...
                        body.find("#qdname").val(newdata.name);
            ...
            layer.confirm('系统将删除当前数据，确认要删除？', {
                ...
                $.ajax({
                    url:"http://8.134.62.33/shopAdmin/get_channel",
                    type: "POST",
                    data: param,
