...
layui.define(['table', 'form'], function(exports){
    ...
    table.render({
        elem: '#LAY-fs-manage',
        // url: "http://8.134.62.33/shopAdmin/get_shop_orders?token="+mybck,
        url: "http://8.134.62.33/receptionAdmin/get_task_orders?token="+mybck+"&action=shopAdmin&shop_status=2",
        cellMinWidth : 95,
        ...
        cols : [[
            ...
            // {field: 'channel_id', title: '渠道ID', width:180, align:'center'},
            {field: 'date', title: '任务日期', width:180, align:'center'},
            {field: 'realization_money', title: '购买金额', width:180, align:'center'},
            {field: 'realization_nums', title: '购买个数', width:180, align:'center'},
            // {field: 'devices_type_id', title: '设备类型', width:180, align:'center'},
            // {field: 'device_id', title: '设备ID', width:180, align:'center'},
            {field: 'shop_status', title: '购粉状态',sort: true,width:150, align:'center',templet:function(d){
                    if(d.shop_status === 1){//未接任务
                        return '<button class="layui-btn layui-bg-red layui-btn-xs">'+'未提交'+'</button>'
                    }else if(d.shop_status === 2){//已接任务
            ...
            var index = layer.open({
                ...
                success : function(layero, index){
                    ...
                    if(newdata) {
                        ...
                        // body.find("#shopstatus").attr("value", newdata.shop_status);
