  ...
  ,admin = {
    ...
    ,sideFlexible: function(status){
      ...
      if(status === 'spread'){
        ...
        //修改（改成滑动后bug
        // app.removeClass(SIDE_SHRINK)
        app.removeClass(SIDE_SHRINK).find(".layui-nav-itemed").children('dl').attr('style','display: block');
        ...
        //修改（改成滑动后bug
        // app.addClass(SIDE_SHRINK);
        app.addClass(SIDE_SHRINK).find(".layui-nav-itemed").find('dl').attr('style','display: none');
