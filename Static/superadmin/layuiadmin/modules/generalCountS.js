...
layui.define(['table', 'form'], function(exports){
    ...
    table.render({
        elem: '#LAY-fs-manage',
        url: "http://8.134.62.33/realizationAdmin/add_people?token="+mybck+"&status=1"+"&mid=superAdmin",
        cellMinWidth : 95,
        ...
        cols : [[
            ...
            {field: 'name', title: '所属', width:180, align:'center'},
