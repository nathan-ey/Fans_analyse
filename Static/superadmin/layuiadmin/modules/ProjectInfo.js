...
layui.define(['table', 'form'], function(exports){
    ...
    table.render({
        elem: '#LAY-fs-manage',
        url: "http://8.134.62.33/receptionAdmin/get_project?token="+mybck+"&status=1&user_id="+UserIDStr,
        // url: "http://8.134.62.33/receptionAdmin/get_task_orders?token="+mybck,
        cellMinWidth : 95,
        ...
        cols : [[
            ...
            {field: 'name', title: '项目类型', width:180, align:'center'},
            ...
            var index = layui.layer.open({
                ...
                success : function(layero, index){
                    ...
                    if(newdata) {
                        ...
                        body.find("#nameP").val(newdata.name);
